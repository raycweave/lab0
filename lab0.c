...
typedef enum stateTypeEnum {WaitForPress, WaitForRelease, LEDToggle, LEDToggle2} stateType;
...
int main(void)
{
	...
	while(1)
	{
		...
		// the initially defined rate.
			...
			if(ledToToggle == 7) {
				LATBbits.LATB13 = 1; //LED 6
				LATBbits.LATB14 = 1; //LED 5
				LATBbits.LATB15 = 1; //LED 4
			//	state = WaitForPress;
